# 🕒 PC Shutdown Manager (So I Can Go to Sleep)
...
- Visual feedback: A colour-coded interface for better readability.

How to use: 
1. run the ShutdownManager.bat file.
2. Set timer: enter the desired number of minutes and press Enter.
3. To cancel the timer, simply run the file again. The script will detect the active timer and stop it immediately.
